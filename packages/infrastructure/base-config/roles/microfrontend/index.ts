...
export const MicrofrontendCluster = async (cluster: eks.Cluster, zone: aws.route53.GetZoneResult, domainName: string, mongoUrl: Output<string>) => {
                ...
                spec: {
                    containers: [{
                        ...
                        env: [
                            ...
                            { name: 'API_URL', value: 'https://staging-api.hexhive.io' },
