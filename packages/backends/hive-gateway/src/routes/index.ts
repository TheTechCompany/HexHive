...
const whitelist = ["http://localhost:3001", 'http://localhost:7000', "https://matrix.hexhive.io", "http://localhost:3002", "http://localhost:3000", "https://hexhive.io", "https://next.hexhive.io", "https://go.hexhive.io"]
