...
module.exports = (webpackConfigEnv, argv) => {
  ...
  return merge(defaultConfig, {
    ...
    entry: './src/HexHive-HiveMarket.tsx',
    externals: [],
    devServer: {
      hot: false
    },
    ...
    output: {
      publicPath: process.env.PUBLIC_PATH || 'http://localhost:8511/'
    },
    plugins: [
      ...
      new webpack.EnvironmentPlugin({
        ...process.env,
        PUBLIC_URL: '/dashboard/market'
      }),  
        new ModuleFederationPlugin({
        name: 'hexhive_hivemarket',
        library: {type: 'var', name: 'hexhive_hivemarket'},
